...
<script>
    (function () {
        ...
        function applySidebarCollapsed(collapsed) {
            html.classList.toggle('sidebar-collapsed', collapsed && isDesktop());
            if (toggleBtn) {
                toggleBtn.setAttribute('aria-label', collapsed ? '{{ __('common.sidebar.expand') }}' : '{{ __('common.sidebar.collapse') }}');
            }
        }
